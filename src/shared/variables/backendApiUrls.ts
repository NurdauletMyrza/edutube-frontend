...
export const enrollInCourseApiUrl = `${backendApiBaseUrl}courses/course/enroll/`;
export const isEnrolledCourseApiUrl = `${backendApiBaseUrl}courses/is-enrolled-course/`;
...
export const userEnrolledCoursesApiUrl = `${backendApiBaseUrl}courses/user-enrolled/`;
